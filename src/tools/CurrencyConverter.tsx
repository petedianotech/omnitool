...
export default function CurrencyConverter() {
  ...
  return (
    <div className="space-y-6 max-w-md mx-auto">
      <div className="flex flex-col gap-4 bg-neutral-50 p-6 rounded-2xl">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full text-3xl font-bold bg-transparent border-b-2 border-neutral-300 focus:border-blue-500 outline-none pb-2"
            min="0"
          />
        </div>
        ...
        <div className="flex items-center gap-4 mt-4">
          <select
            ...
            className="flex-1 p-3 bg-white border border-neutral-200 rounded-xl font-medium"
          >
      ...
      {coffees > 0 && (
        <div className="bg-amber-50 border border-amber-100 p-4 rounded-xl flex items-center gap-4">
          ...
          <div>
            <h4 className="font-semibold text-amber-900">Visual Buying Power</h4>
            <p className="text-sm text-amber-700">This is roughly equivalent to {coffees} coffee{coffees > 1 ? 's' : ''}.</p>
          </div>
        </div>
      )}
    </div>
